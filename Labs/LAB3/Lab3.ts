...
// Tipo pra leitura: tem horário (timestamp) e a temperatura em Celsius.
...
// Mostra a média móvel das leituras, usando 3 valores.



// Tipo pra unidade de temperatura: só aceita 'C' ou 'F'.
type Unidade = 'C' | 'F';
...
// Mostra temperaturas formatada em Celsius e Fahrenheit.
